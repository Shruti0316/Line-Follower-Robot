...
video_path = './lineFollowerSnow.mp4'
...
while(cap.isOpened()):
    ...
    if ret:
        ...
        pts = np.array([[[20, 140], [380, 140], [400, 160], [0, 160]]])
        ...
        cv2.putText(hsv, 'HSV', (100, 120), cv2.FONT_HERSHEY_SIMPLEX, 3, (255, 255, 255), 2, cv2.LINE_AA)

        # Showing the HSV image
        cv2.imshow('HSV', hsv)

        cv2.putText(mask0, 'mask', (80, 120), cv2.FONT_HERSHEY_SIMPLEX, 3, (255, 255, 255), 2, cv2.LINE_AA)
